...
,	H_TEAM_NAME		VARCHAR(100) NOT NULL
,	A_TEAM_NAME		VARCHAR(100) NOT NULL
,	SCHEDULE_TIME	TIME(0)
,	SCORE			VARCHAR(10)
,	RESULT			VARCHAR(100) GENERATED ALWAYS AS (IF(SCORE IS NULL, NULL, IF(SUBSTRING_INDEX(SCORE, ':', 1) > SUBSTRING_INDEX(REVERSE(SCORE), ':', 1), H_TEAM_NAME, IF(SUBSTRING_INDEX(SCORE, ':', 1) = SUBSTRING_INDEX(REVERSE(SCORE), ':', 1), 'Draw', A_TEAM_NAME))))
,	UNIQUE (SCHEDULE_DATE, H_TEAM_NAME, A_TEAM_NAME)
);
...
,	PRED_H_PERC		FLOAT NOT NULL
,	PRED_A_PERC		FLOAT NOT NULL
,	PRED_D_PERC		FLOAT NOT NULL
);